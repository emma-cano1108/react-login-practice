  ...
  return (
    ...
    <div className="container">
      <form>
        ...
        <input type="text" placeholder="Ingrese aquí su usuario" onChange={(e) => {setUser(e.target.value)}}/>
        </div>
        <br />
        <div className="pass">
        <label className="pass-text">Contraseña</label> <br />
        <input type="password" placeholder="Ingrese aquí su contraseña" onChange={(e) => {setPass(e.target.value)}}/>
        </div>
        <br />
